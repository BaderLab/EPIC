...
class SAE_wrapper(MLP_wrapper):
	...
	def fit(self, data, labels):
		...
		encoded = Dense(hidden_layer1, activation='relu', activity_regularizer=regularizers.l1(10e-6))(input)
		...
		self.model.fit(data, labels, epochs=5, batch_size=500, shuffle=True)
"""
# @ author: Lucas Ming Hu
